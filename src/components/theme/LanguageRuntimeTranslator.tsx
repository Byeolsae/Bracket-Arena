...
const exactTranslations: Record<string, string> = {
  ...
  "부전승 없는 2/4/8팀 본선, 0패 / 1패 / 2패 그룹 구조": "No-bye 2/4/8-team playoff with 0-loss / 1-loss / 2-loss groups",
...
const regexTranslations: Array<[RegExp, (match: RegExpMatchArray) => string]> = [
  ...
  [/^(.+)은 부전승 없이 생성하기 위해 (\d+)팀 중 상위 시드 (\d+)팀으로 생성했습니다\.$/, (match) => `${translateText(match[1])} was created with the top ${match[3]} seeds out of ${match[2]} teams to avoid byes.`],
