...
const exactTranslations: Record<string, string> = {
  ...
  "조별 통합": "Group Totals",
  "통합 점수": "Total Scores",
  "A/B/C 조별 통합 점수 테이블": "A/B/C Group Total Score Tables",
  "통합 점수 테이블": "Total Score Table",
  "완료된 로비 경기의 순위점수와 킬점수를 조별로 합산합니다.": "Adds placement points and kill points from completed lobby matches by group.",
  "전체 통합": "Overall Totals",
  "24팀 전체 통합 점수 테이블": "24-Team Overall Score Table",
  "결승 통합 점수 테이블": "Final Overall Score Table",
  "전체 통합 순위 상위 16팀이 배틀로얄 본선으로 올라갑니다.": "The top 16 teams in the overall standings advance to the battle royale final.",
  "모든 결승 로비 경기의 점수를 합산합니다.": "Adds the scores from every final lobby match.",
  "점수 테이블": "Score Table",
  "치킨": "Chicken",
  "보너스": "Bonus",
  "페널티": "Penalty",
...
const japaneseTranslations: Record<string, string> = {
  ...
  "조별 통합": "グループ集計",
  "통합 점수": "合計スコア",
  "A/B/C 조별 통합 점수 테이블": "A/B/Cグループ別合計スコア表",
  "통합 점수 테이블": "合計スコア表",
  "완료된 로비 경기의 순위점수와 킬점수를 조별로 합산합니다.": "完了したロビー試合の順位点とキル点をグループ別に合算します。",
  "전체 통합": "全体集計",
  "24팀 전체 통합 점수 테이블": "24チーム全体合計スコア表",
  "결승 통합 점수 테이블": "決勝合計スコア表",
  "전체 통합 순위 상위 16팀이 배틀로얄 본선으로 올라갑니다.": "全体順位の上位16チームがバトルロイヤル本戦へ進出します。",
  "모든 결승 로비 경기의 점수를 합산합니다.": "すべての決勝ロビー試合のスコアを合算します。",
  "점수 테이블": "スコア表",
  "치킨": "ドン勝",
  "추첨": "抽選",
  "시드 추첨": "シード抽選",
